// A1, Varun Shourie, CIS340, Tuesday/Thursday, 3:00PM-4:15PM
...
public class TaxCalculator {
	...
	public static void main(String[] args) {
		...
		// This instance of the Scanner class was created 
		// to take in user input for variables 
		// like filingStatus and grossIncome
		Scanner scanner = new Scanner(System.in);
		
		// Welcomes and introduces user to the program.
		System.out.println("\t\t\tIncome Tax Calculator\n");
		System.out.println("This program allows you to determine your income taxes.\n");
		
		// Instance of Scanner prompts the user to input 
		// their gross income, which can then be stored
		// for later computation (for values like net income).
		...
		System.out.println("IRS Filing Statuses in Applications: ");
		System.out.println("Single - SG");
		System.out.println("Married, Filing Jointly - MJ");
		System.out.println("Married, Filing Separately - MS");
		...
		System.out.print("Enter your two letter filing status: ");
		...
		// If married & filing jointly, the user is eligible for 
		// a $11900 deduction.
		// If married & filing separately, the user is eligible for
		// a $5950 deduction.
		...
		// The state tax is derived by multiplying a 
		// person's net income by 2.5%.
		stateTax = netIncome * 0.025;
		
		// The final income tax is derived by adding tne 
		// federal tax amount plus the state tax amount. 
		incomeTax = federalTax + stateTax;
		
		// Reminds the user what they stated their gross income was.
		System.out.printf("Your stated income is $%.2f.\n", grossIncome);
		// Outputs the final calculated income tax liability sum based
		// on the gross income given, filing code, and calculations
		// performed above. 
